$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Mike and Julia's Wedding Reception",

      // Event start date
      start: new Date("September 14, 2024 18:00"),
      ...
      end: new Date("September 14, 2024 22:00"),

      // Event Address
      address: "Sunset Park Rooftop, 14b 53rd St, Brooklyn, NY 11232",
...
// Google map
function initMap() {
  var location = { lat: 40.65035721939693, lng: -74.02322205858233 };
